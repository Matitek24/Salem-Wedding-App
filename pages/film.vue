...
<template>
        <Slogan
        greeting="Kadry"
        teamTitle="To wspomnienia"
        teamName="Zapisane na zawsze"
    ...
    <div class="container-sm my-5">
      <div class="row">
        <div class="col-lg-4 mb-4" v-for="(video, index) in videos" :key="index">
          ...
          <p class="video-caption text-center mt-2">ANNA &amp; SEBASTIAN</p>
        </div>
      </div>
    </div>
   <div class="mt-3 pt-3">

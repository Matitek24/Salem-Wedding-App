...
// Sprawdzenie obecności parametru "signature" – jeśli go brak, przekierowanie
if (!route.query.signature) {
  router.push('/') // lub inna strona informacyjna
}
...
// Funkcja pobierająca dane wesela z backendu – dołączamy query string z podpisem
...
// Funkcja wysyłająca dane formularza do backendu – również dołączamy query string
const submitForm = async () => {
  try {
    console.log('Wysyłanie formularza z danymi:', JSON.stringify(form))
    // Przyjmujemy, że API oczekuje parametrów podpisu w query string
